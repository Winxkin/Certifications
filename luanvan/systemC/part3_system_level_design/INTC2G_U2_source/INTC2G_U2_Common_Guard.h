// ---------------------------------------------------------------------
// $Id: INTC2G_U2_Common_Guard.h,v 1.6 2018/12/21 08:25:15 huepham Exp $
//
...
private:
    ...
    void SetTransBasic(unsigned int access_address,unsigned int data_length , unsigned int data, TlmBasicPayload &outTrans);
