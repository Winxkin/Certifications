...
%   {Roll No.:\roll} & \href{mailto:\emaila}{\emaila} \\
  ...
  {Ho Chi Minh City University of Technology and Education} %& \href{\Linkedln}{linkedin}
\end{tabularx}
}
...
{\dimexpr\textwidth-3mm\relax}{|c|C|c|c|c|}
  \hline
  \textbf{Degree/Certificate } & \textbf{Institute/Board} & \textbf{GPA} & \textbf{Year} & \textbf{Supervisor}\\
  \hline
  \href{https://github.com/Winxkin/Data_huan.nguyen-duy/blob/master/Bachelor/SPKT.BE.pdf}{B.E of Computer Engineering} & Ho Chi Minh City University of Technology and Education & \href{https://github.com/Winxkin/Data_huan.nguyen-duy/blob/master/Bachelor/SPKT.Refer.pdf}{3.22} & 2019-2023 & Dr. Thien Huynh-The\\
  \hline
\end{tabularx}}
\vspace{-2mm}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
    {Viettel Group (Semiconductor Technology Division)}{380 Lac Long Quan St,. Nhat Tan, Tay Ho District, Hanoi}
    {\textbf{Embedded Engineer}}{May 2024 - Present}
    \resumeItemListStart
    \item {\textbf{QEMU team | QEMU environment development}}\hfill
    \\ {*Bief project: Responsibility for development QEMU environment to integrate SystemC models and RTL modules into virtual platform. The target of project build virtual platform for emulation and simulation custom SOC.} \\
    \\ {*Fundamental knowledges: modeling techniques, C/Cpp programing, build file system, Verilog.} \\
    \resumeItemListEnd
    
    \resumeSubheading
    {Ban Vien Corporation}{Ban Vien Tower, 54-56-58 Street 2, Van Phuc Residences,Thu Duc district, HCM}
    {\textbf{Embedded Engineer}}{May 2023 - May 2024}
    \resumeItemListStart
...
%     {Keras, Tensorflow, Pytorch*, ROS, OpenCV}
 ...
 {Windows, Linux*.} 
 \resumeSubItem{Technical domain}
  {modeling techniques*, embedded Linux, deep learning*, IC design, academic research*.}
 \resumeSubItem{Non-Technical}
  {reading, writing, listening and speaking for English and VietNamese.}
  \resumeSubItem{Tools}
  {MatLab*, Visual Studio Code*, visual studio*, Latex*, Microsoft Office.}
 \hfill \textit{\footnotesize{*strong skill}} \hspace{3mm}
 \resumeHeadingSkillEnd


\section{Certification}
\resumeHeadingSkillStart
 \resumeSubItem{\href{https://github.com/Winxkin/Data_huan.nguyen-duy/tree/master/Toeic}{TOEIC IIG}} % Category
