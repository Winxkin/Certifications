...
{\dimexpr\textwidth-3mm\relax}{|c|C|c|c|c|}
  ...
  \hline
  \href{https://github.com/Winxkin/Data_huan.nguyen-duy/blob/master/Bachelor/SPKT.BE.pdf}{SPK.BE. Computer Engineering} & Ho Chi Minh City University of Technology and Education & \href{https://github.com/Winxkin/Data_huan.nguyen-duy/blob/master/Bachelor/SPKT.Refer.pdf}{3.22} & 2023 & 2427FD23\\
  \hline
\end{tabularx}}
\vspace{-2mm}
...
%     {Keras, Tensorflow, Pytorch*, ROS, OpenCV}
 ...
 \resumeSubItem{Technical domain}
  {modeling techniques*, embedded linux, deep learning*, IC design.}
