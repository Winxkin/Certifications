...
\vspace{-0.4mm}
\resumeSubHeadingListStart
\resumePOR{Dr.Thien Huynh-The} % Dr.Thien pro
    {Ho Chi Minh University of Technology and Education $|$ \newcommand{email:  }{thienht@hcmute.edu.vn}} %School
    % \\ {\newcommand{email}{thienht@hcmute.edu.vn}}
    \\ {\href{https://scholar.google.com/citations?user=_MLGtqEAAAAJ&;fbclid=IwAR08QAZBO_b35fdm1bM8v0fHEfl3-qivwMlnEFMarkt81gryNO2xrK8cubM}{google scholar}
    ...
    } % My dedicated teacher ^^
\resumePOR{Dr.Khoa Pham-Van} % Position
    {Ho Chi Minh University of Technology and Education $|$ \newcommand{email:  }{khoapv@hcmute.edu.vn}} %Club,Event
