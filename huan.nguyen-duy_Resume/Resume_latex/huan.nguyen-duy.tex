...
\section{Experience}
  ...
  \\ {[5] Generic interrupt controller (GIC-700): Responsibility for designing the redistributor module in the GIC-700 which was developed by ARM. Investigating the GIC-700 specification and planning to design the overview architecture in general and the edistributor module in detail. This model will be adapted to the SOC Renesas platform.}
  \\ 
...
%     {Keras, Tensorflow, Pytorch*, ROS, OpenCV}
 ...
 \resumeSubItem{Technical domain}
  {modeling techniques*, embedded linux, deep learning.}
 \resumeSubItem{Non-Technical}
  {-}
  \resumeSubItem{Tools}
  {Visual Studio Code*, visual studio*, Latex, Microsoft Office.}
 \\ 
